...
async def start(b, m):
        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await StreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://telegra.ph/file/4f8191dbbeb1bb519917f.jpg",
    ...
    reply_markup=InlineKeyboardMarkup(
        [
            [InlineKeyboardButton("Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ 🔰", url=bisal_channel)],
            [
                 InlineKeyboardButton("Aʙᴏᴜᴛ ⁉️", callback_data="about"),
                 InlineKeyboardButton("Hᴇʟᴘ ℹ", callback_data="help")
            ],
            [InlineKeyboardButton("Mᴏᴠɪᴇ Gʀᴏᴜᴘ 🍿", url=bisal_grp)],
...
async def cb_handler(client, query):
    ...
    if data == "start":
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            [
                 InlineKeyboardButton("ᴅɪsᴄʟᴀɪᴍᴇʀ 🚸", url=f"https://graph.org/PAYMENT-METHODS-12-12-2"),
        ...
        await query.message.edit_caption(
            caption=f"<b>Mʏ ɴᴀᴍᴇ :<a href='https://t.me/filetolinknjboi_bot'>{bot_name}</a>\nAᴅᴍɪɴ : <a href='https://t.me/neymar_boi'>NJ Bᴏɪ</a>\nʜᴏsᴛᴇᴅ ᴏɴ : ʜᴇʀᴏᴋᴜ\nᴅᴀᴛᴀʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\nʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ 3</b>",
            reply_markup=InlineKeyboardMarkup(
                [[ 
                     InlineKeyboardButton("ʜᴏᴍᴇ", callback_data="start"),
        ...
        await query.message.edit_caption(
        caption=f"<b>ᴡᴇ ᴅᴏɴᴛ ɴᴇᴇᴅ ᴍᴀɴʏ <a href='https://t.me/botsbynjboi'>ᴄᴏᴍᴍᴀɴᴅs</a> ᴛᴏ ᴜsᴇ ᴛʜɪs ʙᴏᴛ 🤩.\n\nᴊᴜsᴛ sᴇɴᴅ ᴍᴇ <a href='https://t.me/movierequestgroupNj'>ᴠɪᴅᴇᴏ ғɪʟᴇs</a> ᴀɴᴅ ɪ ᴡɪʟʟ ɢɪᴠᴇ ʏᴏᴜ <a href='https://t.me/MovierequestgroupNj'>ᴅɪʀᴇᴄᴛ ᴅᴏᴡɴʟᴏᴀᴅ & sᴛʀᴇᴀᴍᴀʙʟᴇ</a> ʟɪɴᴋ.\n\nᴏʀ ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴍᴇ ɪɴ <a href='https://t.me/botsbynjboi'>ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ</a>..ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ sᴇᴇ ᴍʏ ᴍᴀɢɪᴄ 😎</b>",
            reply_markup=InlineKeyboardMarkup(
[[ 
                     InlineKeyboardButton("ʜᴏᴍᴇ", callback_data="start"),
                     InlineKeyboardButton("ᴄʟᴏsᴇ ‼️", callback_data="close_data")
        ...
        await query.message.edit_caption(
            caption=f"<b>ᴊᴀɪ sʜʀᴇᴇ ᴋʀsɴᴀ ᴅᴇᴀʀ...\nɪᴍ <a href='https://t.me/neymar_boi'>Nᴊ Bᴏɪ</a>\nɪ ᴀᴍ ᴛʜᴇ ᴀᴅᴍɪɴ ᴏғ ᴛʜɪs ʙᴏᴛ..ᴀɴᴅ ɪ ᴍᴀᴅᴇ ᴛʜᴇ  ʙᴏᴛ ʙʏ ʜᴇʟᴘ ᴏғ <a href='https://github.com'>Bɪɪsʜᴀʟ</a> ʙʀᴏ..\n\nIɴsᴛᴀɢʀᴀᴍ : <a href='https://instagram.com/_neymar_boi_'>Nᴊ Bᴏɪ</a></b>",
            reply_markup=InlineKeyboardMarkup(
                [[ 
                     InlineKeyboardButton("ʜᴏᴍᴇ", callback_data="start"),
                     InlineKeyboardButton("ᴄʟᴏsᴇ ‼️", callback_data="close_data")
